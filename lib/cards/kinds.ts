...
function correlationCard(i: CardInput): CardSpec | null {
  ...
  return {
    kind: "correlation",
    eyebrow: "Steadyhands · conviction",
    kicker: "Conviction",
    headline: "Decay",
