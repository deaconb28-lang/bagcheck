...
/**
 * The day Supercruise became a subscription.
 *
...
export function trialLine(trial: TrialState): string | null {
  if (trial.active && trial.endsOn) {
    return `Free through ${trial.endsOn}, no card. After that Supercruise is ${priceLine()}.`;
  }
 ...
 * worst a lapsed account suffered was losing the export formats. Supercruise is
