...
installed, so that a fresh clone of Supercruise has the design skills available
...
`ui-ux-pro-max` is the one Supercruise actually leans on. Its searchable
...
update and would make the version above a lie. Anything Supercruise-specific
...
ui-ux-pro-max plugin, which is true of upstream and false of Supercruise.
