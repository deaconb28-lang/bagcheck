...
/**
 * One bar per trading day in a quarter. Moss days stayed inside the rules;
 * signal days ran above the exposure baseline.
 */
  ...
  return (
    <div className={styles.strip} aria-hidden="true">
      {Array.from({ length: COUNT }, (_, i) => {
        ...
        const moss = v > 1.15;
        const signal = v < -1.05;
        const height = moss ? 62 + H(i) * 10 : signal ? 46 + H(i) * 12 : 14 + H(i) * 30;
        const cls = moss
