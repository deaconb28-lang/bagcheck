...
export const metadata: Metadata = {
  title: "Privacy",
  description:
    "What Supercruise reads from your brokerage, where it is stored, who else sees it, and how to get it back or delete it.",
};
    ...
    <main className={styles.page}>
      <div className={styles.wrap}>
        ...
        <p className={styles.lede}>
          Supercruise reads your brokerage history and turns it into a score and a
        ...
        <section className={styles.section}>
          ...
          <p>
            Supercruise never receives a brokerage password. The connection is made
        ...
        <section className={styles.section}>
          <h2>Children</h2>
          <p>
            Supercruise is not for anyone under 18, and accounts are not knowingly
            created for them.
          </p>
        </section>
